...
class CustomDrawerState extends StatefulWidget {
  ...
  const CustomDrawerState({Key key, this.child}) : super(key: key);

  static _CustomDrawerStateState of(BuildContext context) =>
      context.findAncestorStateOfType<_CustomDrawerStateState>();
